...
#include "Tutorial_Hlms02_MyHlmsListener.h"
...
namespace Final
{
...

            {
...

                {
                    ...
                    Ogre::Archive *archiveLibrary = archiveManager.load(
                        rootHlmsFolder + "2.0/scripts/materials/Tutorial_Hlms02_CustomizationPerObj",
                        archiveType, true );
                    archivePbsLibraryFolders.push_back( archiveLibrary );
                }
    ...
    public:
        Hlms02CustomizationPerObjGraphicsSystem( GameState *gameState ) :
