...
#ifndef Final_Tutorial_Hlms01_Customization_H
#define Final_Tutorial_Hlms01_Customization_H

#include "GraphicsSystem.h"

#include "System/Android/AndroidSystems.h"
#include "Tutorial_Hlms01_MyHlmsListener.h"
...
namespace Final
{
    class Hlms01CustomizationGraphicsSystem final : public GraphicsSystem
    {
        Ogre::MyHlmsListener *mMyHlmsListener;
...

            {
...

                {
                    ...
                    Ogre::Archive *archiveLibrary = archiveManager.load(
                        rootHlmsFolder + "2.0/scripts/materials/Tutorial_Hlms01_Customization",
                        archiveType, true );
                    archivePbsLibraryFolders.push_back( archiveLibrary );
                }
                ...
                mMyHlmsListener = new Ogre::MyHlmsListener();
                hlmsPbs->setListener( mMyHlmsListener );
    ...
    public:
        Hlms01CustomizationGraphicsSystem( GameState *gameState ) :
        ...
        void deinitialize() override
        {
            if( mMyHlmsListener )
            {
                ...
                if( hlms )
                    hlms->setListener( nullptr );  // Don't leave a dangling ptr
                delete mMyHlmsListener;
            }
