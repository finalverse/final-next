...
namespace Final
{
    class StaticShadowMapsGraphicsSystem final : public GraphicsSystem
    {
    ...
    public:
        StaticShadowMapsGraphicsSystem( GameState *gameState ) : GraphicsSystem( gameState ) {}
    };
    ...
    const char *MainEntryPoints::getWindowTitle() { return "Shadow map debugging"; }
}  // namespace Final
