...
namespace Final
{
    ...
    public:
        MorphGraphicsSystem( GameState *gameState ) : GraphicsSystem( gameState ) {}
    };
    ...
    {
        MorphAnimationsGameState *gfxGameState =
            new MorphAnimationsGameState( "This sample shows how to setup morph animations. \n" );
