...
namespace Final
{
    class ParticleFX2GraphicsSystem final : public GraphicsSystem
    {
    ...
    public:
        ParticleFX2GraphicsSystem( GameState *gameState ) : GraphicsSystem( gameState )
        {
    ...
    {
        ParticleFX2GameState *gfxGameState = new ParticleFX2GameState( "" );

        GraphicsSystem *graphicsSystem = new ParticleFX2GraphicsSystem( gfxGameState );
