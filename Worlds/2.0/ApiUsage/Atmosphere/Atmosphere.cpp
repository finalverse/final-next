...
namespace Final
{
                                         ...
                                         GameState **outLogicGameState, LogicSystem **outLogicSystem )
    {
        AtmosphereGameState *gfxGameState = new AtmosphereGameState(
            ...
            "   * Worlds/Media/2.0/scripts/materials/Common/Atmosphere.material\n"
            "   * Worlds/Media/2.0/scripts/materials/Common (shaders in Atmosphere.material)\n"
            "\n" );
    ...
    const char *MainEntryPoints::getWindowTitle() { return "PBS Materials World"; }
}  // namespace Final
