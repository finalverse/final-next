...
namespace Final
{
    class PccPerPixelGridPlacementGraphicsSystem final : public GraphicsSystem
    {
        ...
        void setupResources() override
        {
            ...
            const char *c_locations[5] = { "2.0/scripts/materials/PccPerPixelGridPlacement/",
    ...
    public:
        PccPerPixelGridPlacementGraphicsSystem( GameState *gameState ) : GraphicsSystem( gameState ) {}
    };
