...
namespace Final
{
    class HdrGraphicsSystem final : public GraphicsSystem
    {
    ...
    public:
        HdrGraphicsSystem( GameState *gameState ) : GraphicsSystem( gameState ) {}
    };
    ...
    const char *MainEntryPoints::getWindowTitle() { return "High Dynamic Range (HDR) Sample"; }
}  // namespace Final
